    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://previews.123rf.com/images/dolgachov/dolgachov1308/dolgachov130800957/21574335-bildung-und-schule-konzept-kleine-student-m%C3%A4dchen-studieren-in-der-schule.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>SRNO</label>
                                <input name="srno" type="text" class="form-control"  placeholder="Enter srno">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>SRNO</label>
                                <input value="{{ $student->srno }}" name="srno" type="text" class="form-control"  placeholder="Enter SRNo">
                            </div>
                            <div class="form-group">
                                <label>First Name</label>
